...
//
//
//        PageResponseDTO<MaterialsDTO> responseDTO = productsService.list(pageRequestDTO);
//
...
//
//        int productNo = materialsService.register(productsDTO);
//
...
//            redirectAttributes.addFlashAttribute("errors", bindingResult.getAllErrors());
//
//            redirectAttributes.addAttribute("materialNo", productsDTO.getMaterialNo());
//
...
//    public int getCodeCount(@PathVariable("materialCode") String productCode){
//
